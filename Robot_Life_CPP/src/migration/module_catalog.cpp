...
const std::vector<ModuleMapping>& module_catalog() {
  static const std::vector<ModuleMapping> kCatalog = {
      ...
      ModuleMapping{"robot_life/behavior/bt_runtime.py", "src/behavior/bt_runtime.cpp", "behavior", false},
      ...
      ModuleMapping{"robot_life/common/payload_contracts.py", "src/common/payload_contracts.cpp", "common", false},
      ...
      ModuleMapping{"robot_life/common/state_machine.py", "src/common/state_machine.cpp", "common", false},
      ...
      ModuleMapping{"robot_life/perception/adapters/audio_adapter.py", "src/perception/adapters/audio_adapter.cpp", "perception", false},
      ModuleMapping{"robot_life/perception/adapters/gguf_qwen_adapter.py", "src/perception/adapters/gguf_qwen_adapter.cpp", "perception", false},
      ModuleMapping{"robot_life/perception/adapters/insightface_adapter.py", "src/perception/adapters/insightface_adapter.cpp", "perception", false},
      ModuleMapping{"robot_life/perception/adapters/mediapipe_adapter.py", "src/perception/adapters/mediapipe_adapter.cpp", "perception", false},
      ModuleMapping{"robot_life/perception/adapters/mediapipe_pose_adapter.py", "src/perception/adapters/mediapipe_pose_adapter.cpp", "perception", false},
      ModuleMapping{"robot_life/perception/adapters/motion_adapter.py", "src/perception/adapters/motion_adapter.cpp", "perception", false},
      ModuleMapping{"robot_life/perception/adapters/panns_whisper_audio_adapter.py", "src/perception/adapters/panns_whisper_audio_adapter.cpp", "perception", false},
      ModuleMapping{"robot_life/perception/adapters/qwen_adapter.py", "src/perception/adapters/qwen_adapter.cpp", "perception", false},
      ModuleMapping{"robot_life/perception/adapters/whisper_adapter.py", "src/perception/adapters/whisper_adapter.cpp", "perception", false},
      ModuleMapping{"robot_life/perception/adapters/yamnet_audio_adapter.py", "src/perception/adapters/yamnet_audio_adapter.cpp", "perception", false},
      ModuleMapping{"robot_life/perception/adapters/yolo_pose_adapter.py", "src/perception/adapters/yolo_pose_adapter.cpp", "perception", false},
      ModuleMapping{"robot_life/perception/base.py", "src/perception/base.cpp", "perception", true},
      ModuleMapping{"robot_life/perception/frame_dispatch.py", "src/perception/frame_dispatch.cpp", "perception", false},
      ...
      ModuleMapping{"robot_life/runtime/long_task_coordinator.py", "src/runtime/long_task_coordinator.cpp", "runtime", false},
      ModuleMapping{"robot_life/runtime/pipeline_factory.py", "src/runtime/pipeline_factory.cpp", "runtime", true},
      ModuleMapping{"robot_life/runtime/scene_context.py", "src/runtime/scene_context.cpp", "runtime", false},
      ModuleMapping{"robot_life/runtime/scene_coordinator.py", "src/runtime/scene_coordinator.cpp", "runtime", true},
      ModuleMapping{"robot_life/runtime/scene_ops.py", "src/runtime/scene_ops.cpp", "runtime", false},
      ModuleMapping{"robot_life/runtime/sources.py", "src/runtime/sources.cpp", "runtime", false},
      ...
      ModuleMapping{"robot_life/runtime/ui_slow_scene.py", "src/runtime/ui_slow_scene.cpp", "runtime", false},
      ModuleMapping{"robot_life/slow_scene/__init__.py", "src/slow_scene/__init__.cpp", "slow_scene", true},
      ModuleMapping{"robot_life/slow_scene/queue.py", "src/slow_scene/queue.cpp", "slow_scene", false},
      ModuleMapping{"robot_life/slow_scene/schema.py", "src/slow_scene/schema.cpp", "slow_scene", false},
      ModuleMapping{"robot_life/slow_scene/service.py", "src/slow_scene/service.cpp", "slow_scene", false},
      ModuleMapping{"robot_life/slow_scene/snapshot.py", "src/slow_scene/snapshot.cpp", "slow_scene", false},
      ModuleMapping{"robot_life/slow_scene/worker.py", "src/slow_scene/worker.cpp", "slow_scene", false},
  };
  return kCatalog;
}
