...
echo "==============================================="
echo " Robot Life - Mac Fast Reaction Demo (Hybrid) "
echo "==============================================="
echo "Profile: hybrid"
echo "URL: ${URL}"
echo "This script starts the local hybrid profile and tries to open the browser automatically."
...
"${PROJECT_DIR}/scripts/launch/run_ui_local_fast_reaction.sh" start --hybrid "$@"
